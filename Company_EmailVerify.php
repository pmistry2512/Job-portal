            ...
            <div class="panel panel-default nobottommargin">
              <div class="well well-lg nobottommargin" style="padding: 40px;">
               <div><center><b>We have sent you a verification Code to Registered Email Address</b></center></div><br>
                <form id="verificationcompany" name="verificationcompany" class="nobottommargin" method="post">
                  <input type="hidden" id="callfunction" name="callfunction" value="Verification">
