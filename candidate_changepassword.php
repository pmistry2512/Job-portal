					...
					<div class="container clearfix">
						...
						<div class="tabs divcenter nobottommargin clearfix" id="tab-login-register" style="max-width: 500px;">
								...
								<div class="tab-content clearfix" id="tab-register">
									...
									<form id="candchangepass" name="candchagepass" class="nobottommargin" method="post">				
									<input type="hidden" id="functionname" name="functionname" value="candiadatechangepass"/>
											<div class="col_full">
