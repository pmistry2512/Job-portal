          ...
          <div class="sidebar-widgets-wrap">
            <div class="widget widget-filter-links clearfix">
              ...
              <ul class="custom-filter" data-container="#shop" data-active-class="active-filter">
                ...
                <?php
										$sql="Select * From tblindustry Where industryid In(Select industryid from tbljob where jobstatus='Active')";
										$cnt=1;
                ...
                <li><a href="#" onClick="checkIndustry(<?php echo $rowcompany["industryid"];?>)"><?php echo $rowcompany["industryname"]; ?></a></li>
                <?php
									$cnt++;
									}
									?>
