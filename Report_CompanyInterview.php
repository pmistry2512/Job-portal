	  ...
	  <div class="white-section">
                <div class="row">
                  <form id="companyform" method="post">
                    ...
                    <div class="col-lg-12">
                      <center>
                        <h4>Designation Wise Scheduled Interview</h4>
                      </center>
                    </div>
                    ...
                    <div class="col-sm-5">
                      <div class="form-group">
                        <select class="selectpicker form-control" id="drpdesig" name="drpdesig" style="z-index:9999 !important; position:absolute !important;">
                          ...
                          <?php 
															$sql=@mysql_query("Select * From tbldesignation,tbljobapply,tbljob where tbljob.designation=tbldesignation.designationid And tbljobapply.jobid=tbljob.jobid GROUP BY tbljob.designation") or die (mysql_error());
                    ...
                    <div class="col-sm-2">
                      <button class="button button-3d button-black nomargin" id="submit" name="submit" value="register" type="button" onClick="getdesigwiseinterview()">Submit</button>
                    </div>
					 <div class="col-sm-2">
          <button class="button button-3d button-black nomargin" id="downlaod" name="download" type="button" onClick="getinterviewpdf()">Download</button>
