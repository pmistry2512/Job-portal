  ...
  <section id="content">
	...
	?>
		...
		$sql='';
			...
			$sql=@mysql_query("Select * from tbljobapply,tbljob,tblcandidate,tblcompany,tbldesignation,tbladmin where  tblcandidate.departmentid=tbladmin.departmentid And tbljob.designation=tbldesignation.designationid And tbljob.companyid=tblcompany.companyid And tbljobapply.candidateid=tblcandidate.candidateid And tbljobapply.jobid=tbljob.jobid And tbljobapply.applicationstatus='jobAccepted' And tblcompany.companyid=$_SESSION[LoggedUserId]") or die(mysql_error());
